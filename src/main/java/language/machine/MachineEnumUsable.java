...
//                "l", "ADD", "II", "LDA", data.name, "IL", "0d0", "IL", literal));
    ...
    public void construct(Compiler.MethodCompiler compiler, Classes classes, Map<String, Variable> variables, Variable variable, List<String> generics, String constructorName, List<Argument> arguments, Context context) {
        ...
        new InstructionStatement("l", "ADD", "II", "LDA", data.name, "IL", "0d0", "IL", literal).compile(compiler, variable, Map.of(), context);
    ...
    public void invoke(Compiler.MethodCompiler compiler, Map<String, Variable> variables, Variable variable, String methodName, List<Argument> arguments, Context context) {
        ...
        while(i < arguments.size()) {
            ...
            new InstructionStatement("cb", "NEQ", "AI", "LDA", "val", "IL", literal, instruction).compile(compiler, variable, Map.of(), context);
