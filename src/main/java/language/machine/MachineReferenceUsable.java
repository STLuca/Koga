...
public class MachineReferenceUsable implements Usable {
    ...
    public void construct(Compiler.MethodCompiler compiler, Classes classes, Map<String, Variable> variables, Variable variable, List<String> generics, String constructorName, List<Argument> args, Context context) {
        if (referencedClass != null){
            if (generics.size() != 1) throw new RuntimeException();
            variable.compilableGenerics.put(referencedClass, classes.compilable(generics.get(0)));
        }
    ...
    public void invoke(Compiler.MethodCompiler compiler, Map<String, Variable> variables, Variable variable, String methodName, List<Argument> args, Context context) {
        Map<String, Argument> argsByName = new HashMap<>();
